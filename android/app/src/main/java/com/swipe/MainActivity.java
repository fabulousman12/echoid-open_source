...
public class MainActivity extends BridgeActivity implements IUnityAdsInitializationListener {
    ...
    private static final String ONESIGNAL_APP_ID = "xxxxxxxxx";
...
public  static String unitytest = "xxxxxxxx";
    private static final String UNITY_GAME_ID = "xxxxxxx"; // replace with real
...
//}));
    ...
    public void setAudioRoute(String route) {
        final String normalized = "headset".equalsIgnoreCase(String.valueOf(route)) ? "headset" : "speaker";
        setSpeakerphoneOn("speaker".equals(normalized));
    }
        ...
        runOnUiThread(() -> {
            try {
                ...
                if (audioManager == null) {
                    Log.w("MainActivity", "AudioManager unavailable for speaker toggle");
                    return;
                }

                audioManager.setMode(AudioManager.MODE_IN_COMMUNICATION);
                audioManager.setSpeakerphoneOn(enabled);
                Log.d("MainActivity", "Audio route set to " + (enabled ? "speaker" : "headset"));
            } catch (Exception e) {
                Log.e("MainActivity", "Failed to set audio route", e);
            }
        });
    }
